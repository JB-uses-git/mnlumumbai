          ...
          <div className="guidelines-section">
            ...
            <div className="guidelines-text">
              ...
              <div className="timeline-footer">
                <p>
                  The Editorial Board is committed to reverting with the final decision within <strong>two-three weeks</strong> of receiving the submission. In case of no update regarding the submission, the author can raise their complaint through <strong><a href="mailto:calstar@mnlumumbai.edu.in">calstar@mnlumumbai.edu.in</a></strong>
                </p>
                <p>
